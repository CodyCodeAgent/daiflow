...
class TaskWorkflow:
    ...
    transitions = [
        ...
        # Failure recovery — stay at current stage or go back one step for retry
        {'trigger': 'reset_init',    'source': 'initializing', 'dest': 'created'},
        {'trigger': 'reset_plan',    'source': 'planning',     'dest': 'planning'},
        {'trigger': 'reset_todos',   'source': 'plan_locked',  'dest': 'planning'},
        {'trigger': 'reset_review',  'source': 'reviewing',    'dest': 'coding'},
    ]
