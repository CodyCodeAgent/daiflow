...
from daiflow.models import Conversation, ConversationStatus, Task, TaskStatus, Todo
...
class StageChatContext:
    session_id: str
    cody_client: Any  # AbstractAgentRunner (context manager); field kept as cody_client for compatibility
