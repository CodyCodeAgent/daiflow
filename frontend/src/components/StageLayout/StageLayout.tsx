...
interface StageLayoutProps {
  ...
  chatOnSend: (msg: string, opts?: ChatSendOptions) => void
  ...
  onRetry?: () => void
  /** Whether a cancel request has been sent but not yet confirmed. */
  chatCancelling?: boolean
  /** Called when user clicks the stop button during chat streaming. */
  chatOnStop?: () => void
  /** Disable chat panel independently of stage readonly (e.g. during run-all) */
        ...
        <ResizableSplitPane
          right={
            <ChatPanel
              ...
              onStop={chatOnStop}
              title={chatTitle}
              disabled={readonly || !!chatDisabled}
              taskId={taskId}
            />
          }
        >
