const en = {
  ...
  'init.view_skills': 'View Generated Skills',
  ...
  'tasks.skills_label': 'Skills (auto-inherited from project)',
  'tasks.no_project_skills': 'No project skills yet. Run project init to generate.',
  'tasks.extra_skills_placeholder': 'Search manual skills (coding standards, conventions...)',
  ...
  'skills.page_desc': 'Manage all AI skills in one place. Skills can be generated by projects, uploaded manually, or synced from external sources.',
  'skills.add': 'Upload Skill',
  'skills.name': 'Skill Name',
  'skills.name_placeholder': 'e.g. coding-standards, api-conventions',
  'skills.description': 'Description',
  'skills.desc_placeholder': 'Brief description, e.g. "Team coding conventions for React projects"',
  'skills.content': 'Content',
  'skills.content_placeholder': '# Coding Standards\n\n## Naming Conventions\n- Components: PascalCase\n- Functions: camelCase\n\n## File Structure\n- One component per file\n- Co-locate tests with source\n\n(Write your skill content in Markdown)',
  'skills.save': 'Save',
  'skills.cancel': 'Cancel',
  'skills.edit': 'Edit',
  'skills.delete': 'Delete',
  'skills.delete_confirm': 'Are you sure you want to delete this skill? This cannot be undone.',
  'skills.created': 'Skill created',
  'skills.updated': 'Skill updated',
  'skills.deleted': 'Skill deleted',
  'skills.empty': 'No skills yet',
  'skills.loading': 'Loading...',
  'skills.select_hint': 'Select a skill to view details',
  'skills.filter_all': 'All',
  'skills.filter_project': 'Project',
  'skills.filter_manual': 'Manual',
  'skills.filter_external': 'External',
